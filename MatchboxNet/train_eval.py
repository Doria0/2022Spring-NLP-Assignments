...
import numpy as np
import torch
from data import CLASSES, _collate_fn
...
if __name__ == '__main__':
    ...
    model = MatchboxNet(B=3, R=2, C=64).cuda()
    ...
    for epoch in range(epochs):
        ...
        for batch in pbar:
            ...
            if cur_step % print_step == 0:
                logging.info("[training]epoch {}\tloss: {}\tacc:{}\t".format(epoch, total_loss / cur_step,
                                                                             (correct / total_sample) * 100))
        # testing
        ...
        logging.info(
            "[test]epoch {}\tloss: {}\tacc:{}\t".format(epoch, total_loss / cur_step, (correct / total_sample) * 100))
